	...
	<div class="raw">
	    <div class="navi-bar">
	        <ul class="nav nav-pills nav-stacked">
		        <li class="nav-batt"><a href="http://localhost">Главная</a></li>
		        <li class="nav-batt"><a href="#tovari" data-toggle="collapse" >Товары и услуги</a>
					<div id="tovari" class="collapse in">
						<ul>
							<li>
								<a href="/goods">Все товары</a>
							</li>
							<li>
								<a href="/goods+1">Опалубка</a>
							</li>
							<li>
								<a href="/goods+2">Леса</a>
							</li>
							<li>
								<a href="/goods+3">Комплектующее</a>
							</li>
						</ul>		
					</div>
		        </li>
		        <li class="nav-batt"><a href="http://localhost/about">О Нас</a></li>
		        <li class="nav-batt"><a href="http://localhost/contacts">Контакты</a></li>
	        </ul>
	    </div>
	</div>
	</br>
...
<div class="tab-content">
	<div class="tab-pane fade in active" id="contacts" >
		...
		<ul style="text-align: left;">
			<li>
				<td>+7-978-739-06-35</td>
				<td>Николай</td> 
			</li>
			<li>
				<td>+7-978-784-40-02</td>
				<td>Дмитрий</td> 
			</li>
			<li>
				<td>+7-978-024-03-71</td>
				<td >Тагир</td> 
			</li>
		</ul>		
	</div>
